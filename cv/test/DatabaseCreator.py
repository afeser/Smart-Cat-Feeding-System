...
class DatabaseCreator:
    ...
    def seperate_into_databases(self, source_database_dir, database_file_path, dest_dir='seperate_into_databases', override=False):
        ...
        parser.parse(database_file_path)

        num_classes = parser.get_value('num_classes')

        train_start = parser.get_value('train_start')
        train_end   = parser.get_value('train_end')

        val_start   = parser.get_value('val_start')
        val_end     = parser.get_value('val_end')

        test_start  = parser.get_value('test_start')
        test_end    = parser.get_value('test_end')

        all_exludes = parser.get_value('all_exludes')
